...
namespace LostItems
{
	public class Junkan_b : CompanionItem
	{
		public static GameObject prefab;
		private static readonly string guid = "junk_boi_123"; //give your companion some unique guid
		float damageBuff = -1;
		...
		public static void Init()
		{
			...
			var item = obj.AddComponent<Junkan_b>();
			...
			item.CompanionGuid = Junkan_b.guid;
		...
		public static void BuildPrefab()
		{
			...
			prefab = CompanionBuilder.BuildPrefab("junk", guid, "LostItems/sprites/Pets/mistake/mistake_pet_idle_001", new IntVector2(1, 0), new IntVector2(9, 9));
